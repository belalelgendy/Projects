...
#define LCD_ENABLE_PIN         			  PORTA2           //PORTD_PIN0
#define LCD_Read_Write_PIN     			  PORTA1           //PORTD_PIN1
#define LCD_Data_Command_PIN     		  PORTA0           //PORTD_PIN2
...
void u32Diplay_NUMBER_XY(u8 row, u8 pos,u32 num);
void f32Diplay_NUMBER_XY(u8 row, u8 pos,f32 num);
